...
# 预测结果
def plot_engConsModelTrainResult():
    ...
    for i in range(6):
        ...
        plt.plot(data['年份'].values, engConsTrainPredict[i], 'bo-')  # 预测值
        plt.plot(data['年份'].values, engConsTrainGT[i], 'ro--')  # GroundTruth
        plt.xlabel('时间 - 年')
        ...
        plt.plot(data['年份'].values, engConsErr[i], 'r*--')  # 误差
        plt.xlabel('时间 - 年')
...
# 绘图
def plot_cFactorModelTrainResult():
    for i in range(6):
        ...
        plt.plot(data['年份'].values, cFactorTrainPredict[i], 'bo-')  # 预测值
        plt.plot(data['年份'].values, cFactorTrainGT[i], 'ro--')  # GroundTruth
        plt.xlabel('时间 - 年')
        ...
        plt.plot(data['年份'].values, cFactorErr[i], 'r*--')  # 误差
        plt.xlabel('时间 - 年')
...
def plot_totalCEmisTrainRes():
    ...
    plt.plot(data['年份'].values, carbEmisPredict[6], 'bo-')  # 预测值
    plt.plot(data['年份'].values, carbEmisGT, 'ro--')  # GroundTruth
    plt.xlabel('时间 - 年')
